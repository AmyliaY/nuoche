...
<form id="form" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div id="wrapperX">
		...
		<ul>
			...
			<li>
				<ul class="fillList lineHeightA" style="margin-top: 0; border-top: none;">
					<li>
						...
						<span class="fill_inB"><input type="text" name="title"></span>
					</li>
					<li>
						<span class="fill_inA">市场价格：</span>
						<span class="fill_inB"><input type="text" name="shichangPrice"></span>
					</li>
					<li>
						<span class="fill_inA">预约价格：</span>
						<span class="fill_inB"><input type="text" name="yuyuePrice"></span>
					</li>
					<li>
						<span class="fill_inA">服务时间：</span>
						<span class="fill_inB"><input type="text" name="time"></span>
					</li>
			...
			<li>
				<div class="con_a">
					<a onclick="addservice()" class="butA butRed" style="margin-top: 0;">确认添加</a>
				</div>
			</li>
		</ul>
	</div>
...
<script type="text/javascript">
	function addservice(){
		...
		$.ajax({
			type:"post",
			url:"${pageContext.request.contextPath}/sjyuyueservice.do?p=addservice",
			cache: false,  
