		...
		<table class="table table-hover table-bordered">
			...
			<tr class="ttk">
				<td colspan="2" align="center">
					<button onclick="go(0)"  type="submit" style="width:80px;height:40px;margin-top: 30px;">下载图像</button>
					<button onclick="go(1)"  type="submit" style="width:80px;height:40px;margin-top: 30px;">下载Excel</button>
				</td>
			</tr>
		</table>
	</form>
