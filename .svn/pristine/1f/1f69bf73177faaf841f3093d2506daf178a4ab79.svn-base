		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<tr>
                                                        ...
                                                        <td width="30%"><input class="input-text" onblur="name_onblur()"  type="text" id="gname" name="gname" value="" /></td>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>地址(必填)：</td>
                                                        <td><input class="input-text" onblur="dizhi_onblur()"  type="text" id="gaddress" name="gaddress" value="" /></td>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>支付用户(必填)：</td>
                                                        <td><input class="input-text" onblur="zuobiaox_check(this)"  type="text" id="gzuobiaox" name="gzuobiaox" value="" /></td>
                                                        ...
                                                        <td width="2%">&nbsp;</td>
                                                        <td>支付密码(必填)：</td>
                                                        <td><input class="input-text" onblur="zuobiaoy_check(this)"  type="text" id="gzuobiaoy" name="gzuobiaoy" value="" /></td>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td colspan="3"><input style="width: 200px" class="btn btn-primary radius" id="xinzeng" disabled="disabled" onclick="add_jyz()" class="btn" type="submit" value="提交" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
			</tbody>
		</table>
...
function test(){
    ...
    //跳转
    function add_jyz(){
      document.form1.action="${pageContext.request.contextPath}/daili_jiayouzhang.do?p=add_jyz";
